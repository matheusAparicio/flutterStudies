...
class _HomePageState extends State<HomePage> {
  ...
  void calculate() {
    setState(() {
      ...
      resultString =
          resultIMC <= 0 ? "" :
          resultIMC < 16.5 ? "Peso severamente abaixo do normal: " : 
          resultIMC < 18.5 ? "Peso abaixo do normal: " : 
          resultIMC < 24.99 ? "Normal: " :
          resultIMC < 29.99 ? "Pré-obeso: " :
          resultIMC < 34.99 ? "Obesidade classe I: " :
          resultIMC < 39.99 ? "Obesidade classe II: " :
